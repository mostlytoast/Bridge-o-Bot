...
#             # # time.sleep(.01)
#             # joy=joyaxis()
#             # # if ((joy.button_11==0)and (a==1)):

#             # #     t=t*-1
#             # #     print(t)
#             # #print('ss')
#             # velocity = translate(joy.axis[1],1,-1,0,180)
#             # turn = translate(joy.axis[0],-1,1,-90,90)
#             # #maps the joystick inputs to correct vals
#             # leftdrive = constrain(velocity+turn,0,180)
#             # rightdrive = constrain(velocity-turn,0,180)
#             # send(leftdrive,rightdrive)
